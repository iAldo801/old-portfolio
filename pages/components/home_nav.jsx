        ...
        <section id="about" className="min-h-screen">
            ...
            <div>
                ...
                <nav className="user-select-none py-10 mb-12 justify-between text-white hidden md:flex">
                    <h1 className="font-poppinsBold text-4xl">Aldo.</h1>
            ...
            <div className="p-10 py-10">
                <h1 className="font-poppinsBold text-4xl py-2 text-white text-shadow md:text-6xl">
                    Hi, I'm Aldo Hernandez 👋
                </h1>
                <h3 className="font-poppinsBold text-4xl gradient-animation">
                    Frontend Developer
                </h3>
                <p className='font-poppins text-md py-5 leading-8 text-white max-w-xl md:text-xl'>
                    ...
                    enjoy playing video games and hanging out with friends :D.
                </p>
                <div>
