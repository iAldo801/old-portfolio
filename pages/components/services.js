    ...
    <section id="services" className="min-h-screen">
      ...
      <div className="relative container">
        <div className="lg:flex gap-10">
          <div className="text-center shadow-2xl p-10 rounded-xl my-10 bg-slate-800 flex-1 floating-animation">
            <h3>
          ...
          <div className="text-center shadow-lg p-10 rounded-xl my-10 bg-slate-800 flex-1 floating-animation">
